        ...
        <div class="card-body">
            <form action="{{ route('siswa.store') }}" method="post" onsubmit="return validasiForm()">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" maxlength="10" name="NRP" id="NRP" class="form-control" value="{{ old('NRP') }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" maxlength="20" name="Nama" id="Nama" class="form-control" value="{{ old('Nama') }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" maxlength="5" name="Kelas" id="Kelas" class="form-control" value="{{ old('Kelas') }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" maxlength="5" name="TanggalLahir" id="TanggalLahir" class="form-control" value="{{ old('TanggalLahir') }}">
                    </div>
                </div>
